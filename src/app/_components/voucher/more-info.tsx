          ...
          >
            <div className="space-y-6 px-8 pb-6">
              <ol className="list-disc space-y-2 pl-4">
                ...
                <li>
                  Após o pagamento, volte para o site para visualizar seu
                  voucher
                </li>
                <li>Envie o voucher para o WhatsApp da cachoeira das araras</li>
                <li>
                  Depois é só apresentar o código do voucher na portaria para
                  entrar
                </li>
              </ol>
              ...
              <div className="space-y-2">
                <p>
                  ...
                  essa data, ele não será mais válido.
                </p>
                <p>
                  Os vouchers não são reembolsaveis, verifique a data que
                  pretende ir antes de finalizar a compra.
                </p>
              </div>
            </div>
          </motion.section>
