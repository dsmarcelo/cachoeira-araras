...
export default async function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-bg-blue text-primary-200">
      <ImageCarousel />
      <div className="w-full max-w-5xl flex flex-col justify-center gap-6 px-4 py-4 md:py-8 md:px-8 lg:flex-row">
        <VoucherBuy />
        <InfoCard />
      </div>
      <div className="container flex flex-col items-center justify-center gap-6 px-4 py-4 md:py-8">
