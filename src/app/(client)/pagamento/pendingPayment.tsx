...
export default function PendingPaymentCard({
  ...
  const handlePaymentClick = () => {
    if (!isOnline) {
      toast({
        title: "Sem conexão",
        description:
          "Você está offline. Verifique sua conexão com a internet antes de continuar.",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleRefresh = () => {
    if (!isOnline) {
      toast({
        title: "Sem conexão",
        description:
          "Você está offline. Verifique sua conexão com a internet antes de atualizar.",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="mx-auto mb-auto mt-12 flex max-w-xl flex-col gap-4 px-4">
      ...
      <Button
        ...
        disabled={!isOnline}
        className="h-14 text-lg disabled:cursor-not-allowed disabled:opacity-50"
      >
